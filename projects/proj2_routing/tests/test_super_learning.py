...
Make sure that everything works well and correctly

Creates the following topology, then sends a series of
pings. Then checks that the proper amount of pings and pongs are recieved.
